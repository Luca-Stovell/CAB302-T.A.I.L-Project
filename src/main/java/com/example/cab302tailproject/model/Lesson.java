...
public class Lesson extends Material {
     ...
     */
    public Lesson(String topic, String content, int teacherID) {
     ...
     */
    public Lesson(String topic, String content, Instant lastModifiedDate, int teacherID, int materialID) {
